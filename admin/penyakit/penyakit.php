...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Data Penyakit dan Saran</h1>
      <nav style="--bs-breadcrumb-divider: '>';">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Admin</a></li>
          <li class="breadcrumb-item">Master Data</li>
          <li class="breadcrumb-item active">Data Penyakit dan Saran</li>
        </ol>
      </nav>
      <hr>
    </div><!-- End Page Title -->
        ...
        <div class="card-body pt-4 px-0">
          <table id="myTable" class="table table-striped table-hover table-responsive">
            ...
            <tbody>
              <?php
              include "../koneksi.php";
              $sql = "SELECT * FROM tb_penyakit  ORDER BY CAST(SUBSTRING(kdpenyakit, 2) AS SIGNED)";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mx-auto">Tambah Data Penyakit & Saran</h5>
        </div>
